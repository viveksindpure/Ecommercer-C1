...
public class DatabaseConnection {
	...
	{ //creating a table return 0 for execute update
		...
		try
		{
			...
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/?autoReconnect=true&useSSL=false",
					"root",root);
		   ...
		   // System.out.println(x);
			...
			query=con.prepareStatement("create table admininfo ( AdminId int not null, Name varchar(20) not null, "
					+ "Age int not null, Email varchar(30) not null, Address varchar(30) not null, "
					+ "ContactNumber varchar(11) not null, primary key(AdminID) )");
		    x=query.executeUpdate();
		    //System.out.println(x);
			/*if(x==0)
